...
import com.SpartaGlobal.GroupA.WebFramework.pom.Pages.products.BikeLightPage;
import org.junit.jupiter.api.*;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.chrome.ChromeDriver;
import org.openqa.selenium.chrome.ChromeOptions;

public class BikeLightPageTests {
    ...
    void setupEach() {
        ...
        bikeLightPage = inventoryPage.goToBikeLightPage();
    }

    @Test
    @DisplayName("Check navigation from inventory page to backpack page")
    public void navigateToBikeLightPageTest() {
        Assertions.assertEquals("https://www.saucedemo.com/inventory-item.html?id=0", bikeLightPage.getURL());
    }
    ...
    public void cartTests() {
        ...
        Assertions.assertEquals(1, bikeLightPage.itemsInCart());
        bikeLightPage.removeBikeLightFromCart();
        bikeLightPage.addBikeLightToCart();
        Assertions.assertEquals(1, bikeLightPage.itemsInCart());
    }
    ...
    public void navigateToInventoryPageTest() {
        bikeLightPage.backToProductsButton();
        Assertions.assertEquals("https://www.saucedemo.com/inventory.html", bikeLightPage.getURL());
    }
